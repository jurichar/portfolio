...
const About = () => {
  const items = [
    ...
    },
    {
      ...
      description:
        "As a freelance full-stack developer, I work on various projects including developing web applications and websites for small businesses using a wide range of technologies such as Next.js, React, Django, and Tailwind. I have also gained valuable experience in backend development.",
      tags: [
        "JavaScript",
        "TypeScript",
        "React.js",
